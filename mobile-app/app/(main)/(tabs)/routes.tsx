    ...
    <SafeAreaView className="flex-1" style={{ backgroundColor: theme.background }}>
      <ScrollView className="flex-1">
        ...
        <View className="px-4 mt-4">
          <Text className="text-lg font-semibold mb-3" style={{ color: theme.text }}>{t('routes.recent')}</Text>
          ...
          {isLoading ? (
            ...
            <View className="p-6 rounded-lg shadow-sm items-center" style={{ backgroundColor: theme.surface }}>
              ...
              <Text className="text-lg font-medium mb-2" style={{ color: theme.text }}>{t('routes.noRoutes')}</Text>
